...
" Uer defined
syn keyword cStatement true false void wchar_t char long int short 
syn keyword cTypedef BOOL HANDLE CHAR UCHAR INT UINT SHORT USHORT LONG ULONG DWORD
syn keyword cMacro TRUE FLASE NULL
syn keyword cNameSpace std 
