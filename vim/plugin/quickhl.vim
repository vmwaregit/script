...
if !exists("g:quickhl_colors")
  let g:quickhl_colors = [
        ...
        \ "gui=bold ctermfg=7   ctermbg=18   guibg=#a07040 guifg=#ffffff",
        \ "gui=bold ctermfg=7   ctermbg=22   guibg=#4070a0 guifg=#ffffff",
        \ "gui=bold ctermfg=7   ctermbg=53   guibg=#40a070 guifg=#ffffff",
        \ "gui=bold ctermfg=52   ctermbg=59   guibg=#70a040 guifg=#ffffff",
        \ "gui=bold ctermfg=88   ctermbg=57   guibg=#0070e0 guifg=#ffffff",
        \ "gui=bold ctermfg=124   ctermbg=63   guibg=#007020 guifg=#ffffff",
        \ "gui=bold ctermfg=202   ctermbg=89  guibg=#d4a00d guifg=#ffffff",
        \ "gui=bold ctermfg=7   ctermbg=95  guibg=#06287e guifg=#ffffff",
        \ "gui=bold ctermfg=7   ctermbg=238  guibg=#5b3674 guifg=#ffffff",
        \ "gui=bold ctermfg=7   ctermbg=201  guibg=#4c8f2f guifg=#ffffff",
        \ "gui=bold ctermfg=7   ctermbg=166  guibg=#1060a0 guifg=#ffffff",
        \ "gui=bold ctermfg=7   ctermbg=46  guibg=#a0b0c0 guifg=black",
        \ ]
endif
